...
- (void)viewDidLoad {
	...
	region.center.latitude = 42.36340;
	region.center.longitude = -71.05800;
	...
	//SITE 1
	NSString *latitude =  @"42.35224";
	NSString *longitude = @"-71.06276";
	...
	annotation.mTitle=@"1. Liberty Tree";
	annotation.mSubTitle=@"2 Boylston Street";
	...
	annotation.mTitle=@"2. Boston Common";
	annotation.mSubTitle=@"139 Tremont Street";
	...
	annotation.mTitle=@"3. Massachusetts State House";
	annotation.mSubTitle=@"24 Beacon Street";
	...
	annotation.mTitle=@"4. Park Street Church";
	annotation.mSubTitle=@"1 Park Street";
	...
	annotation.mTitle=@"5. Granary Burying Ground";
	annotation.mSubTitle=@"1 Park Street";
	...
	annotation.mTitle=@"6. King's Chapel";
	annotation.mSubTitle=@"58 Tremont Street";
	...
	annotation.mTitle=@"7. King's Chapel Burying Ground";
	annotation.mSubTitle=@"58 Tremont Street";
	...
	annotation.mTitle=@"8. Franklin Statue, Boston Latin School";
	annotation.mSubTitle=@"45 School Street";
	...
	annotation.mTitle=@"9. Old Corner Bookstore";
	annotation.mSubTitle=@"25 School Street";
	...
	annotation.mTitle=@"10. Old South Meeting House";
	annotation.mSubTitle=@"310 Washington Street";
    ...
    annotation.mTitle=@"11. Old State House";
    annotation.mSubTitle=@"206 Washington Street";
    ...
    annotation.mTitle=@"12. Boston Massacre Site";
    annotation.mSubTitle=@"206 Washington Street";
    ...
    annotation.mTitle=@"13. Faneuil Hall";
    annotation.mSubTitle=@"1 Faneuil Hall Square";
    ...
    annotation.mTitle=@"14. Paul Revere House";
    annotation.mSubTitle=@"19 North Square";
    ...
    annotation.mTitle=@"15. Old North Church";
    annotation.mSubTitle=@"193 Salem Street";
    ...
    annotation.mTitle=@"16. Copp's Hill";
    annotation.mSubTitle=@"Corner of Hull and Snow streets";
    ...
    annotation.mTitle=@"17. U.S.S. Constitution";
    annotation.mSubTitle=@"Charlestown Navy Yard";
    ...
    annotation.mTitle=@"18. Bunker Hill Monument";
    annotation.mSubTitle=@"Monument Square";

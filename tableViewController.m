...
- (void)viewDidLoad {
	...
	NSDictionary *row1 = [[NSDictionary alloc] initWithObjectsAndKeys:@"1. Liberty Tree", @"Name", @"2 Boylston Street",@"Address",@"nolahtable1",@"Image", nil];
	NSDictionary *row2 = [[NSDictionary alloc] initWithObjectsAndKeys:@"2. Boston Common", @"Name", @"139 Tremont Street",@"Address",@"nolahtable2",@"Image",  nil];
	NSDictionary *row3 = [[NSDictionary alloc] initWithObjectsAndKeys:@"3. Massachusetts State House", @"Name", @"24 Beacon Street",@"Address",@"nolahtable3",@"Image",  nil];
	NSDictionary *row4 = [[NSDictionary alloc] initWithObjectsAndKeys:@"4. Park Street Church", @"Name", @"1 Park Street",@"Address",@"nolahtable4",@"Image",  nil];
	NSDictionary *row5 = [[NSDictionary alloc] initWithObjectsAndKeys:@"5. Granary Burying Ground", @"Name", @"1 Park Street",@"Address",@"nolahtable5",@"Image",  nil];
	NSDictionary *row6 = [[NSDictionary alloc] initWithObjectsAndKeys:@"6. King's Chapel", @"Name", @"58 Tremont Street",@"Address",@"nolahtable6",@"Image",  nil];
	NSDictionary *row7 = [[NSDictionary alloc] initWithObjectsAndKeys:@"7. King's Chapel Burying Ground", @"Name", @"58 Tremont Street",@"Address",@"nolahtable7",@"Image",  nil];
	NSDictionary *row8 = [[NSDictionary alloc] initWithObjectsAndKeys:@"8. Franklin statue, Boston Latin School", @"Name", @"45 School Street",@"Address",@"nolahtable8",@"Image",  nil];
	NSDictionary *row9 = [[NSDictionary alloc] initWithObjectsAndKeys:@"9. Old Corner Bookstore", @"Name", @"25 School Street",@"Address",@"nolahtable9",@"Image",  nil];
	NSDictionary *row10 = [[NSDictionary alloc] initWithObjectsAndKeys:@"10. Old South Meeting House", @"Name", @"310 Washington Street",@"Address",@"nolahtable10",@"Image",  nil];
    NSDictionary *row11 = [[NSDictionary alloc] initWithObjectsAndKeys:@"11. Old State House", @"Name", @"206 Washington Street",@"Address",@"nolahtable11",@"Image",  nil];
    NSDictionary *row12 = [[NSDictionary alloc] initWithObjectsAndKeys:@"12. Site of the Boston Massacre", @"Name", @"206 Washington Street",@"Address",@"nolahtable12",@"Image",  nil];
    NSDictionary *row13 = [[NSDictionary alloc] initWithObjectsAndKeys:@"13. Faneuil Hall", @"Name", @"1 Faneuil Hall Square",@"Address",@"nolahtable13",@"Image",  nil];
    NSDictionary *row14 = [[NSDictionary alloc] initWithObjectsAndKeys:@"14. Paul Revere House", @"Name", @"19 North Square",@"Address",@"nolahtable14",@"Image",  nil];
    NSDictionary *row15 = [[NSDictionary alloc] initWithObjectsAndKeys:@"15. Old North Church", @"Name", @"193 Salem Street",@"Address",@"nolahtable15",@"Image",  nil];
    NSDictionary *row16 = [[NSDictionary alloc] initWithObjectsAndKeys:@"16. Copp's Hill", @"Name", @"Corner of Hull and Snow streets",@"Address",@"nolahtable16",@"Image",  nil];
    NSDictionary *row17 = [[NSDictionary alloc] initWithObjectsAndKeys:@"17. U.S.S. Constitution", @"Name", @"Charlestown Navy Yard",@"Address",@"nolahtable17",@"Image",  nil];
    NSDictionary *row18 = [[NSDictionary alloc] initWithObjectsAndKeys:@"18. Bunker Hill Monument", @"Name", @"Monument Square",@"Address",@"nolahtable18",@"Image",  nil];
